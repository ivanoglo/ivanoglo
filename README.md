...
<ul style="color:#333333; font-size:15px; line-height:1.6; padding-left:20px;">
  ...
  <li>
    <strong>Former Founding Engineer</strong> of a profitable AI platform scaled to
    <strong>200,000+</strong> users, leading full-stack architecture, LLM pipelines,
    and distributed infrastructure.
  </li>
  <li>
    Specialized in <strong>C++/Python integration</strong>, achieving over
    <strong>10,000×</strong> performance gains in quantum simulation, with expertise in
    scientific computing and error correction.
  </li>
  <li>
    Proven ability to take complex systems from prototype to production, combining
    hardware-aware design, backend optimization, and reliable automation.
  </li>
</ul>

<p style="font-size:14px; line-height:1.5;">
<span style="color:#6f42c1;"><strong>📍 Location:</strong></span> Blaustein, Germany<br>
